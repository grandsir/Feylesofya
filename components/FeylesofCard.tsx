  ...
  return (
    <div className="relative max-w-md mx-auto bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 md:pt-48 pt-32 shadow-2xl shadow-slate-600 shadow-inner-2xl rounded-2xl md:mt-32 m-16 md:max-w-2xl justify-center">
      <div className="relative max-w-md mx-auto bg-gradient-to-b from-white to-[#cfcaca] rounded-b-2xl md:max-w-2xl justify-center">
        ...
        <button className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-2xl font-qs text-[#070202] rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800">
          <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-[#d2cbcd] dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
            TAKİP ET
          </span>
        </button>
      </div>
