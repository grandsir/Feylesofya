...
const PostCard = (post: Post) => {
    ...
    <div className="glass-block max-w-2xl mx-auto mb-4">
                        ...
                        <div className="absolute bottom-0 left-0">
                            {
                                post.node.categories.map((category, index) =>
                                        <div
                                            className={`max-w-40 cursor-pointer hover:scale-105 relative ml-2 inline-flex shadow-xl p-0.5 mb-4 overflow-hidden text-sm font-medium text-gray-800 rounded-full group bg-gradient-to-br ${gradients[Math.floor(Math.random() * gradients.length)]}`}>
        ...
        <hr></hr>
            <div
                className="hidden sm:flex justify-between md:justify-left lg:mb-3 w-full rounded-b-lg px-5 pt-3 lg:p-5">
                {
